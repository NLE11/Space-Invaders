...
{
    public class Squid2 : AlienCategory
    {
        public Squid2(Sprite.Name spriteName, float posX, float posY)
        : base(GameObject.Name.Squid2, spriteName, posX, posY)
        {
            this.x = posX;
            this.y = posY;
