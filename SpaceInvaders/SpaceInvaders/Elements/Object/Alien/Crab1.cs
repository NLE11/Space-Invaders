...
{
    public class Crab1 : AlienCategory
    {
        public Crab1(Sprite.Name spriteName, float posX, float posY)
        : base(GameObject.Name.Crab1, spriteName, posX, posY)
        {
            this.x = posX;
            this.y = posY;
