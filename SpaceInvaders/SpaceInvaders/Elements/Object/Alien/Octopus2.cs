...
{
    public class Octopus2 : AlienCategory
    {
        public Octopus2(Sprite.Name spriteName, float posX, float posY)
        : base(GameObject.Name.Octopus2, spriteName, posX, posY)
        {
            this.x = posX;
            this.y = posY;
