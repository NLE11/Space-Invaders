...
namespace SpaceInvaders
{
    ...
    {
        public BumperLeft(GameObject.Name name, Sprite.Name spriteName, float positionX, float positionY, float width, float height)
            : base(name, spriteName, positionX, positionY, BumperCategory.Type.Left)
        {
