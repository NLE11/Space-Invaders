...
{
    public class SceneIntro1 : SceneState
    {
        // Data
        ...
        {
            Font font = FontManager.Add(Font.Name.TestMessage, SpriteBatch.Name.Texts, "PLAYER 1", Glyph.Name.Consolas36pt, 440, 450);
